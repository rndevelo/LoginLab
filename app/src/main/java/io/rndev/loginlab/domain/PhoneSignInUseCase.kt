...
class PhoneSignInUseCase @Inject constructor(private val authRepository: AuthRepository) {
    operator fun invoke(): Flow<Result<Boolean>> = channelFlow {
...
//                launch {
//                    authRepository.phoneSingIn(credential).collectLatest { result ->
//                        send(result)
//                    }
//                }
//            }
